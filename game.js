...
choices.forEach((choice) => {
    choice.addEventListener('click', (e) => {
        ...
        // Call incrementScore when the answer is correct
        if (classToApply === 'correct') {
            incrementScore(CORRECT_BONUS);
        }

        // If the answer is incorrect, find and highlight the correct choice
        ...
        setTimeout(() => {
            // Remove highlighting of correct answer and selected choice
            choices.forEach((choice) => {
